...
;---------Configuracion Timers----------------		 
		...
		MOV		#00001100B,TPM2C0SC; CONFIGURACION CANAL CAPTURA
...
CICLO:	BRCLR	CH2F,TPM1C2SC,*; PREGUNTA SI PASO UN 1S
		BCLR	CH2F,TPM1C2SC; LIMPIA BANDERA
		;BSET	LRESET,PTCD;
		MOV		#00000100B,TPM2C0SC; CONFIGURACION CANAL CAPTURA
		BRCLR	CH2F,TPM2C0SC,*;
		BCLR	CH2F,TPM2C0SC;
		LDHX	#0H
		STHX	TPM2CNTH; REINICIO CONTADOR
		MOV		#00001000B,TPM2C0SC; CONFIGURACION CANAL CAPTURA
		BRCLR	CH2F,TPM2C0SC,*;
		BCLR	CH2F,TPM2C0SC;
		LDHX	TPM2C0VH
		JSR		OPERAR
...
NIVEL:  LDA		VALOR_M
		...
		BLT		VACIADO
		BGT		LLENADO
NADA:	BCLR	LLENAR,PTCD
		BCLR	VACIAR,PTCD
		RTS
VACIADO:BCLR	LLENAR,PTCD
		BSET	VACIAR,PTCD
		RTS
LLENADO:BSET	LLENAR,PTCD
		BCLR	VACIAR,PTCD
		RTS
;--------RUTINA CONTADOR--------------------------------
CONTEO:	LDA		CONT;
